...
I utilize the **[NeetCode.io](https://neetcode.io)** curriculum to systematically master core computer science fundamentals and prepare for high-scale software engineering challenges.
...
*   **Iterative Optimization:** Where applicable, you will find multiple submission files (`submission-0`, `submission-1`) tracking my journey from a brute-force approach to a highly optimized, production-grade pattern.
...
│
└── 📁 <problem-slug>/
    ├── 📄 submission-0.java  ← Initial working solution / baseline approach
    └── 📄 submission-1.java  ← Optimized variant (e.g., Two-Pointer, Sliding Window, or DP)
